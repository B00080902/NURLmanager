...
class Collection extends \AppBundle\Entity\Collection implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Collection' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Collection' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Collection' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Collection' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\Collection' . "\0" . 'nurl', '' . "\0" . 'AppBundle\\Entity\\Collection' . "\0" . 'public', '' . "\0" . 'AppBundle\\Entity\\Collection' . "\0" . 'shared'];
        }
    ...
    public function setShared($shared)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setShared', [$shared]);
    ...
    public function getShared()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getShared', []);
