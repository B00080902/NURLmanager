...
class Report extends \AppBundle\Entity\Report implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Report' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Report' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Report' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\Report' . "\0" . 'timestamp'];
        }
